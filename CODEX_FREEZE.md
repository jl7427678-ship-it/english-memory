...
- Vocabulary Cloud Sync 仅同步词汇 progress/resume 与 `vocabBatchSize`、`vocabShowRelationsAfterAnswer`；必须保持 Local-first、Email OTP、RLS owner isolation，禁止整份 state 上传及任何 service_role/secret 进入浏览器
