...
const defaultState={docs:[],activeDoc:null,study:{index:0,mode:'full'},logs:{},vocab:{decks:[],activeDeck:null,session:null,builtinInstalled:{},progress:{}},vocabLogs:{},todayChecklist:{},projects:defaultProjects(),planner:defaultPlanner(),examEngine:{questions:[],attempts:[],wrong:{},review:{}},questionEngine:{drafts:{},review:{},checks:{},planTasks:[],activePlanId:null},settings:{speechRate:.9,speechLang:'en-US',apiEndpoint:'',apiModel:'',apiKey:'',vocabBatchSize:'100'}};
