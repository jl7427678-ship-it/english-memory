...
assert(app.includes("src+'?v=20260906-24'") && app.includes("'app-18.js'"), 'split application scripts are not on the current version');
...
assert(worker.includes("CACHE='english-memory-lab-v5-ui-20260906-24'") && worker.includes('app-18.js') && worker.includes('data/ielts-atlas-manifest.json') && worker.includes('data/italian-manifest.json'), 'Service Worker cache version was not bumped');
