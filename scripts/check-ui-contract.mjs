...
const runtimeFiles = ['app-1.js', 'app-2.js', 'app-3.js', 'app-4.js', 'app-5.js', 'app-6.js', 'app-7.js', 'app-8.js', 'app-9.js', 'app-10.js', 'app-11.js'];
...
for (const page of ['today', 'library', 'training', 'plan', 'me', 'study', 'vocab', 'exam', 'exam-engine', 'review', 'stats', 'settings', 'preqin-literature', 'private-library']) {
