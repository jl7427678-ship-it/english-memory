const CACHE='english-memory-lab-v5-ui-20260905-11';
const CORE=['./','./index.html','./manifest.webmanifest','./icon.svg','./styles.css','./theme.css','./boot.js','./ui.html','./app.js','./app-1.js','./app-2.js','./app-3.js','./app-4.js','./app-5.js','./app-6.js','./app-7.js','./assets/mascot/wanwang-hello.webp','./assets/mascot/wanwang-celebrate.webp','./assets/mascot/wanwang-reading.webp','./data/toeic-manifest.json','./data/toeic-core.json','./data/preqin-literature.json'];
